...
class LoginView: UIView {
    ...
    @objc private func textFieldEditingChanged(_ textField: UITextField) {
        ...
        // 정규식을 둘다 통과했을때만 활성화
        if checkManager.isValidEmail(email: email) == true && checkManager.isValidPassword(pw: password) == true {
        ...
        print("이메일 양식 확인 : \(checkManager.isValidEmail(email: email))")
        print("비밀번호 양식 확인 : \(checkManager.isValidPassword(pw: password))")
